...
<header class="top-bar">
    ...
    <div class="location-selector" id="locationSelector">
        ...
        <span class="location-text" id="locationText">Jardim Curitiba</span>
        <span>▾</span>
    </div>
...
<div class="search-container">
    <div class="search-box">
        ...
        <input type="search" class="search-input" placeholder="Buscar restaurantes, pratos ou eventos" id="searchInput">
...
<nav class="bottom-nav">
    <div class="nav-items">
        ...
        <a href="/meus-pedidos" class="nav-item">
            <svg class="nav-icon" viewBox="0 0 24 24">
        ...
        <a href="/minha-conta" class="nav-item">
            <svg class="nav-icon" viewBox="0 0 24 24">
